...
import 'package:pageview/widegts/page_indicator.dart';


class PageViewCourses extends StatefulWidget {
  const PageViewCourses({super.key});

  @override
  State<PageViewCourses> createState() => _PageViewCoursesState();
}

class _PageViewCoursesState extends State<PageViewCourses>
